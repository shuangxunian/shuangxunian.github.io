# 关于我
欢迎来到我的博客！我是霜序廿，一个喜欢算法的前端er，爱好是代码，原神，联盟，看书，Apex；21年毕业于沈阳航空航天大学计算机学院，21.7-25.1就职于杭州一家crm公司；当今在找前端工作，如果您对我感兴趣，请直接邮箱联系我，我的邮箱：shuangxunian@gmail.com~
...
介绍：大学做过的一个竞赛，现在想从头到尾重新做一下。闭源
  1. 逻辑层：c语言；处理运行逻辑，计算下一步位置
  2. 展示层：棋盘，并判断对弈双方行棋是否合法，与exe通信；技术栈：electron vue2 express
  3. 分值处理：将c语言根据分值对弈获得的结果整合 通过SVM模型计算出最优范围；技术栈：python3 numpy

4. 量化交易
时间：2025-至今
类别：数据处理，量化交易
介绍：基于这个[仓库](https://github.com/BigBrotherTrade/trader)魔改的，策略是用的一个身边大佬的交易策略，目前正在调优。闭源
todo：
  - 逻辑优化，期望年收益15%，能达到10%就开源
  - 打通飞书
  - 自动交易

如果您对3 4感兴趣也欢迎和我邮件沟通，知无不言，无限进步。
