...
![](https://api2.mubu.com/v3/document_image/017d718c-2829-4972-9165-3cbd20e57f79-3807603.jpg)
...
![](https://api2.mubu.com/v3/document_image/6a206b65-ba3f-400e-8850-7ef0bcf3f743-3807603.jpg)
...
![](https://api2.mubu.com/v3/document_image/08ad4369-d988-461a-88ef-881132c912b9-3807603.jpg)

Chrome:

![](https://api2.mubu.com/v3/document_image/5cb32386-6729-46c8-bee5-c6a1fef12230-3807603.jpg)
...
![](https://api2.mubu.com/v3/document_image/12dce2a8-d6ed-42bd-8251-ef8d5c18bb65-3807603.jpg)
...
![](https://api2.mubu.com/v3/document_image/f72707c2-5c62-40f2-bd02-1212c41417e9-3807603.jpg)
...
![](https://api2.mubu.com/v3/document_image/777bd3e2-998e-48e7-a2f6-d060f1e184af-3807603.jpg)

Referer Check 不仅能防范 CSRF 攻击，另一个应用场景是 “防止图片盗链”。

#### 添加 token 验证
CSRF 攻击之所以能够成功，是因为攻击者可以完全伪造用户的请求，该请求中所有的用户验证信息都是存在于 Cookie 中，因此攻击者可以在不知道这些验证信息的情况下直接利用用户自己的 Cookie 来通过安全验证。要抵御 CSRF，关键在于在请求中放入攻击者所不能伪造的信息，并且该信息不存在于 Cookie 之中。可以在 HTTP 请求中以参数的形式加入一个随机产生的 token，并在服务器端建立一个拦截器来验证这个 token，如果请求中没有 token 或者 token 内容不正确，则认为可能是CSRF 攻击而拒绝该请求。
